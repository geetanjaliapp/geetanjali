      ...
      <div className="flex flex-wrap gap-2">
        {displayQuestions.map((question, idx) => (
          <button
            ...
            className="text-left text-xs px-3 py-2 bg-[var(--badge-warm-bg)] hover:bg-[var(--badge-warm-hover)] text-[var(--badge-warm-text)] rounded-[var(--radius-chip)] border border-[var(--border-warm)] transition-[var(--transition-color)] max-w-full sm:max-w-none cursor-pointer"
            title={question}
          >
