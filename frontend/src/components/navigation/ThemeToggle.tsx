...
export function ThemeToggle({ variant = "navbar" }: ThemeToggleProps) {
  ...
  return (
    <button
      onClick={cycleTheme}
      className="p-2 rounded-lg text-gray-600 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2"
      aria-label={`Current: ${label}. Click to change theme.`}
      title={label}
    >
      <svg
