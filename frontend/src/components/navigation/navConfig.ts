 ...
 * 3. Topics - explore teachings by principle/topic (v1.31)
 * 4. Read - deep sequential reading (after finding content)
 * 5. About - trust-building, mission/purpose (v1.23 - moved back to navbar for visibility)
 */
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    to: "/topics",
    label: "Topics",
    mobileLabel: "Explore Topics",
    icon: "topics",
    activePrefixes: ["/topics"],
  },
  {
    to: "/read",
    label: "Read",
