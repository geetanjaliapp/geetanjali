...
export function FeaturedVerse({
  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto">
        <div className="bg-[var(--surface-warm)] rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-12 border border-[var(--border-warm)] shadow-xl">
          <div className="text-center space-y-4">
            <div className="h-6 sm:h-8 bg-[var(--surface-muted)] rounded-sm animate-pulse w-20 sm:w-24 mx-auto" />
            <div className="h-24 sm:h-32 bg-[var(--surface-muted)] rounded-sm animate-pulse" />
          </div>
        </div>
      </div>
    );
  ...
  if (error) {
    return (
      <div className="max-w-4xl mx-auto">
        <div className="bg-[var(--surface-warm)] rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-12 border border-[var(--border-warm)] shadow-lg">
  ...
  return (
    ...
    >
      ...
      <div className="bg-[var(--surface-warm)] rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-12 border border-[var(--border-warm)] shadow-xl hover:shadow-2xl hover:border-amber-300  transition-all cursor-pointer">
