...
const FAMOUS_VERSES = [
  {
    ...
    paraphrase_en: 'Focus on executing your responsibilities diligently without obsessing over outcomes. Commit fully to action while detaching from results, avoiding procrastination and passivity.',
  },
  {
    canonical_id: 'BG_18_66',
    chapter: 18,
    verse: 66,
    sanskrit_devanagari: 'सर्वधर्मान्परित्यज्य मामेकं शरणं व्रज।अहं त्वा सर्वपापेभ्यो मोक्षयिष्यामि मा शुचः।।18.66।।',
    paraphrase_en: 'Surrender rigid protocols; trust your core principles. Release perfectionism and guilt. Decisive leaders embrace simplicity over complexity to achieve meaningful results.',
  },
  {
    canonical_id: 'BG_4_7',
    chapter: 4,
    verse: 7,
    sanskrit_devanagari: 'यदा यदा हि धर्मस्य ग्लानिर्भवति भारत।\n\nअभ्युत्थानमधर्मस्य तदाऽऽत्मानं सृजाम्यहम्।।4.7।।',
    paraphrase_en: 'When righteousness declines and unrighteousness rises, leaders must take decisive action to restore ethical order and moral values in their organizations and society.',
  },
  {
    canonical_id: 'BG_2_22',
    chapter: 2,
    verse: 22,
    sanskrit_devanagari: 'वासांसि जीर्णानि यथा विहाय\n\nनवानि गृह्णाति नरोऽपराणि।\n\nतथा शरीराणि विहाय जीर्णा\n\nन्यन्यानि संयाति नवानि देही।।2.22।।',
    paraphrase_en: 'Leaders must release outdated strategies and embrace new approaches to remain effective, understanding that organizational evolution requires letting go of what no longer serves progress.',
  },
  {
    ...
    paraphrase_en: 'Perform your duties with detachment from outcomes, maintaining mental balance through success and failure. This equanimity is the essence of effective leadership and decision-making.',
  },
];
