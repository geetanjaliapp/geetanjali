...
export default function PublicCaseView() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      setError('This consultation is not publicly accessible or does not exist.');
    } finally {
      setLoading(false);
    }
  }, [slug]);
        ...
        <div className="max-w-2xl mx-auto px-3 sm:px-4">
          ...
          <div className="mb-4 sm:mb-6 bg-gradient-to-r from-orange-100 to-amber-100 border border-orange-200 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3">
            <p className="text-xs sm:text-sm text-gray-700">
              ...
              <Link to="/cases/new" className="text-orange-600 hover:text-orange-700 font-medium">
              ...
              return (
                <div key={exchange.user.id}>
                  ...
                  <div className="relative pl-8 sm:pl-10 pb-3 sm:pb-4">
                    ...
                    <div className={`text-xs font-semibold uppercase tracking-wide mb-1.5 sm:mb-2 ${
                          ...
                          {isSourcesExpanded && (
                            <div className="mt-2 sm:mt-3 space-y-2">
                              {exchange.output.result_json.sources.map((source) => (
                                <div key={source.canonical_id} className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg p-2.5 sm:p-3 border border-orange-100">
                                  <div className="flex items-center justify-between">
                                    <Link to={`/verses/${source.canonical_id}`} className="font-mono text-orange-700 font-semibold text-xs sm:text-sm hover:underline">
          ...
          {firstOutput && (
            ...
            <div className="mt-8 pt-6 border-t border-orange-200/50">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-sm font-semibold text-gray-900">Guidance Summary</h2>
                  <p className="text-xs text-gray-500">Key insights from this consultation</p>
                </div>
              </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs sm:text-sm text-gray-600 mt-0.5">
                            {firstOutput.result_json.options.length} approaches
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex sm:grid sm:grid-cols-3 gap-2 overflow-x-auto pb-1 sm:pb-0 -mx-1 px-1 sm:mx-0 sm:px-0">
                        {firstOutput.result_json.options.map((opt, idx) => (
                          ...
                          >
                            ...
                            <div className={`text-xs sm:text-sm font-medium mt-1 leading-snug ${selectedOption === idx ? 'text-red-900' : 'text-gray-700'}`}>
                    ...
                    <div className="flex items-center justify-between bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-3 sm:p-4 shadow-sm border border-purple-100 hover:shadow-md transition-shadow">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs sm:text-sm text-gray-600 mt-0.5">
                            {firstOutput.result_json.reflection_prompts.length} prompts
                          </p>
                        </div>
                      </div>
          ...
          <div className="mt-6 sm:mt-8 bg-white rounded-xl shadow-md p-4 sm:p-6 text-center">
            <h3 className="font-semibold text-gray-900 text-sm sm:text-base mb-1.5 sm:mb-2">Need guidance for your situation?</h3>
            <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4">
              Start your own consultation and receive personalized wisdom from the Bhagavad Geeta.
            </p>
            <Link
              to="/cases/new"
