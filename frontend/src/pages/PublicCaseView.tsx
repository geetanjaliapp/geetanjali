    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-red-50 flex flex-col">
      ...
      <div className="flex-1 py-6">
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="mb-6 bg-gradient-to-r from-orange-100 to-amber-100 border border-orange-200 rounded-xl px-4 py-3">
          ...
          <div className="mt-8 bg-white rounded-xl shadow-md p-6 text-center">
            <h3 className="font-semibold text-gray-900 mb-2">Need guidance for your situation?</h3>
            <p className="text-sm text-gray-600 mb-4">
              Start your own consultation and receive personalized wisdom from the Bhagavad Gita.
            </p>
            <Link
              to="/cases/new"
              className="inline-block px-6 py-3 bg-orange-600 text-white rounded-xl hover:bg-orange-700 transition-colors font-medium"
            >
              Start a Consultation
            </Link>
          </div>
